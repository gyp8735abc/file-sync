...
package com.foxjc.service.file.sync.http.httpserver.spi;
...
import com.foxjc.service.file.sync.http.httpserver.HttpsServer;
                ...
                .doPrivileged(new PrivilegedAction<Object>() {
                        public Object run() {
                            ...
                            if (loadProviderAsService())
                                return provider;
                            provider = new com.foxjc.service.file.sync.http.httpserver.impl.DefaultHttpServerProvider();
                            return provider;
                        }
                    });
        }
